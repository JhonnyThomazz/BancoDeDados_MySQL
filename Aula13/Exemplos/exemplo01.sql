...
##inner join - Retorna registro entre ambas as tabelas
select func.funnome as nome_funcionario, depen.depennome as nome_dependente
from funcionario func
inner join dependente depen
on func.funcodigo = depen.funcodigo;

##left join - Retorna registros da tabela esquerda que tem relação com a da direita
...
##Left EXCLUDING join - Retorna registros da tabela esquerda que não tem relação com a da direita
select func.funnome as nome_funcionario, depen.depennome as nome_dependente
from funcionario func
...
##right join - Retorna registros da tabela direita que tem relação com a da esquerda
select func.funnome as nome_funcionario, dep.depennome as nome_dependente
from funcionario func
right join dependente dep
on func.funcodigo = dep.funcodigo;

##right EXCLUDING join - Retorna registros da tabela direita que não tem relação com a da esquerda
select func.funnome as nome_funcionario, dep.depennome as nome_dependente
from funcionario func
right join dependente dep
on func.funcodigo = dep.funcodigo
...
##Full join - Consulta de todas as tabelas e regsitros
select func.funnome as nome_funcionario, depen.depennome as nome_dependente
from funcionario func
left join dependente depen
on func.funcodigo = depen.funcodigo
